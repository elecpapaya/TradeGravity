...
- Add a repeatable release checklist and publish the first tagged release.

## Next: usability and reuse

- Add an accessible table alternative to the treemap.
- Improve keyboard navigation, focus states, and small-screen layouts.
- Add downloadable filtered CSV/JSON views.
